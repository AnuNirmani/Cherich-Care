...
class QEleven extends StatelessWidget {
    ...
    return Scaffold(
      ...
      body: Container(
        ...
        child: Column(
          ...
          children: [
            Image.asset(
            'assets/images/rf9.png', // Put your image path here
              height: 200,
              width: 100,
              fit: BoxFit.contain,
            ),
  ...
  children: [
    ElevatedButton(
      onPressed: () => _saveResponse(context, '20+ minutes'),
    ...
    ElevatedButton(
      onPressed: () => _saveResponse(context, '8+ minutes'),
      style: ElevatedButton.styleFrom(
    ...
    ElevatedButton(
      onPressed: () => _saveResponse(context, '5 minutes or less'),
      style: ElevatedButton.styleFrom(
        backgroundColor: Colors.white,
        side: const BorderSide(color: Colors.black, width: 1),
        shape: RoundedRectangleBorder(
    ...
    const SizedBox(height: 18),
    ElevatedButton(
      onPressed: () => _saveResponse(context, 'I am a statue'),
      style: ElevatedButton.styleFrom(
        backgroundColor: Colors.white,
        side: const BorderSide(color: Colors.black, width: 1),
        shape: RoundedRectangleBorder(
