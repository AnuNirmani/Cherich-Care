...
class QEighteen extends StatelessWidget {
    ...
    return Scaffold(
      ...
      body: Container(
        ...
        child: Column(
          ...
          children: [
            Image.asset(
            'assets/images/logo.png', // Put your image path here
              height: 200,
              width: 100,
              fit: BoxFit.contain,
            ),
            ...
            Container(
              ...
              child: Column(
                children: [
                  const Text(
                    "Finally, have you had a mastectomy?",
                    style: TextStyle(
                      fontSize: 20,
                      fontWeight: FontWeight.bold,
                      color: Colors.black,
  ...
  children: [
    ElevatedButton(
      onPressed: () => _saveResponse(context, 'Yes, both breasts'),
    ...
    ElevatedButton(
      onPressed: () => _saveResponse(context, 'Yes, one breast'),
      style: ElevatedButton.styleFrom(
