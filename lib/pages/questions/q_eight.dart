...
import 'package:cherich_care_2/pages/questions/q_nine.dart';
import 'package:cherich_care_2/pages/questions/q_seven.dart';
...
class QEight extends StatelessWidget {
      ...
      if (currentUser != null) {
        ...
        if (context.mounted) {
          Navigator.pushAndRemoveUntil(
            context,
            MaterialPageRoute(builder: (context) =>  QNine()),
            (route) => false,
          );
        }
      } else {
    ...
    return Scaffold(
      appBar: AppBar(
        ...
        leading: IconButton(        
          ...
          onPressed: () {
            Navigator.pushAndRemoveUntil(
              context,
              MaterialPageRoute(builder: (context) => QSeven()),
              (route) => false,
            );
          },
        ),
      ...
      body: Container(
        ...
        child: Column(
          ...
          children: [
            Image.asset(
            'assets/images/q8.png', // Put your image path here
              height: 100,
              width: 100,
              fit: BoxFit.contain,
            ),
